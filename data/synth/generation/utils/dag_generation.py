...
if __name__ == "__main__":
    ...
    #dag = generate_dag(10, 0.5, 0.5, seed=42, dot_path="dag.dot")
    dag = nx.Graph(nx.nx_pydot.read_dot("synth/data/hc.dot"))
    truth_dag = nx.Graph(nx.nx_pydot.read_dot("synth/data/dag.dot"))