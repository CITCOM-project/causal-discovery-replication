#!/bin/bash
#SBATCH --job-name=cta_cs3_sd
#SBATCH --output=logs/cta_cs3_sd/output_%A_%a.txt
#SBATCH --error=logs/cta_cs3_sd/error_%A_%a.txt
...
OUTPUT_FILE="data/cta/nsga_sd_cs3/output_nsga_alpha_${val}_seed_${seed}.dot"
