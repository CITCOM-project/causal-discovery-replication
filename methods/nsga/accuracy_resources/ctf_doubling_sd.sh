#!/bin/bash
#SBATCH --job-name=ctf_doubling_sd
#SBATCH --output=logs/ctf_doubling_sd/output_%A_%a.txt
#SBATCH --error=logs/ctf_doubling_sd/error_%A_%a.txt
...
OUTPUT_FILE="data/ctf/nsga_doubling_sd/output_nsga_alpha_${val}_seed_${seed}.dot"
