...
OUTPUT_FILE="data/ctf/nsga_doubling_dk/output_nsga_percent_${percent}_seed_${seed}_alpha_${alpha}.dot"
...
/usr/bin/time -v causal-testing discover \
    ...
    -o "$OUTPUT_FILE" \
    -a $alpha \
    -e "partials/ctf_doubling_percent_${percent}_seed_${seed}_excluded.dot" \
    -i "partials/ctf_doubling_percent_${percent}_seed_${seed}_included.dot" \
