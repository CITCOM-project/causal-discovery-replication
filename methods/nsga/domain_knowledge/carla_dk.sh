...
#SBATCH --output=logs/nsga_carla_dk/output_%A_%a.txt
#SBATCH --error=logs/nsga_carla_dk/error_%A_%a.txt
...
OUTPUT_FILE="data/carla/nsga_dk/output_nsga_percent_${percent}_seed_${seed}_alpha_${alpha}.dot"
