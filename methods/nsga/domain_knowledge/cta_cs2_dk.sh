...
OUTPUT_FILE="data/cta/nsga_dk_cs2/output_nsga_percent_${percent}_seed_${seed}_alpha_${alpha}.dot"
...
/usr/bin/time -v causal-testing discover \
    ...
    -o "$OUTPUT_FILE" \
    -a $alpha \
    -e "partials/cta_cs2_percent_${percent}_seed_${seed}_excluded.dot" \
    -i "partials/cta_cs2_percent_${percent}_seed_${seed}_included.dot" \
